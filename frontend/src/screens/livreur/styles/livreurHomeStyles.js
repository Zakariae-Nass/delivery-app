...
export const card = StyleSheet.create({
  ...
  appliedText: { color: SUCCESS, fontSize: 13, fontWeight: '600' },
  urgentPill: { backgroundColor: 'rgba(230,57,70,0.10)', borderWidth: 1, borderColor: '#E63946' },
  urgentLabel: { fontSize: 11, fontWeight: '800', color: '#E63946' },
  metaBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: LIGHT_BG,
